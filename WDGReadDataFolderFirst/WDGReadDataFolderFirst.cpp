...
bool WDGPlugin::GenerateNewPatch()
{
	...
	try
	{
		...
		sFindData.lpData = "\x80\xab\xab\xab\xab\x00\x00\x53\x8b\x5c\x24\x0c\x57\x8b\x7c\x24\x14\x57\x53\x74\x18\xe8\xab\xab\xab\xab";
		sFindData.uDataSize = 26;
	...
	{
		sprintf_s(szMsg, 256, "WDGReadDataFolderFirst2012 :: Part 1 :: %s", lpszMsg);
		m_dgc->LogMsg(szMsg);
		return false;
	}
	...
	{
		sprintf_s(szMsg, 256, "WDGReadDataFolderFirst2012 :: Part 2 :: %s", lpszMsg);
		m_dgc->LogMsg(szMsg);
		return false;
	}
